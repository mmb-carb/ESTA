...
class Emfac2014CsvLoader(EmissionsLoader):
    ...
    def load_daily(self, emissions):
        ...
        """
        file_paths = os.path.join(self.directory, '%02d', '%02d', 'statewide_run_emission.csv')
    ...
    def read_emfac_file(self, file_path, region=0):
        """ Read an EMFAC2021 LDV CSV emissions file and colate the data into a table.
            File Format:
